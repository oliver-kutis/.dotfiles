# Generated by Powerlevel10k configuration wizard on 2025-01-17 at 08:59 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 27205.
# Wizard options: nerdfont-v3 + powerline, small icons, rainbow, unicode,
# vertical separators, round heads, blurred tails, 2 lines, disconnected, left frame,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=018
