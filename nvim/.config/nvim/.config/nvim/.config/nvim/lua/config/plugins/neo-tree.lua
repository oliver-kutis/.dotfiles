...
return {
  ...
  keys = {
    ...
    { '<leader>ef', ':Neotree filesystem reveal float<CR>', desc = 'Explorer', silent = true },

    -- Git Status (Floating)
    { '<leader>eg', ':Neotree git_status reveal float<CR>', desc = 'Git Status', silent = true },

    -- Buffers
    { '<leader>eb', ':Neotree buffers reveal float<CR>', desc = 'Buffers', silent = true },
  },
  sources = {
    'filesystem',
    'buffers',
  ...
  opts = {
    ...
    filesystem = {
      ...
      window = {
        mappings = {
          ['\\'] = 'close_window',
          ['.'] = { 'show_help', nowait = false, config = { title = '[Root] [s]et [r]eset', prefix_key = '.' } },
          ['.s'] = 'set_root',
