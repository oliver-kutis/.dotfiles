...
require("lazy").setup({
	...
	-- Surround
	-- allows to edit surrounding quotes, brackets, ...
	{
	...
	},
	{
		...
		config = function()
			...
			local servers = {
				-- Remove pylsp completely, add pyright
				pyright = {
				...
				ruff = {
					...
					init_options = {
						settings = {
							...
							lint = {
								select = { "E", "W", "F", "I", "UP", "B", "C4", "SIM", "TCH" },
								extendSelect = { "I" },
								ignore = { "E501", "E712", "B904" },
								extendIgnore = { "E203", "W503" },
								enable = true,
								pycodestyle = {
	...
	-- 		},
	-- 		ruff = {
	-- 			prepend_args = { "--extend-select", "I", "--line-length", "88" },
	-- 		},
	-- 	},
	-- },
